...
declare namespace pxt.editor {
  ...
  export interface EditorMessageProjectCloudStatus
    extends EditorMessageRequest {
  ...
  export interface EditorMessageRenderPythonRequest
    extends EditorMessageRequest {
    action: "renderpython";
    // typescript code to render
    ts: string;
  ...
  export interface EditorMessageToggleTraceRequest
    extends EditorMessageRequest {
    action: "toggletrace";
  ...
  export interface EditorMessageGetBlockAsTextRequest
    extends EditorMessageRequest {
  ...
  export interface IProjectView {
    ...
    compile(): void;
    compileOnlyPostMessage(onlyPostMessage: boolean): void;
  ...
  export interface ExtensionResult {
    ...
    renderIncompatibleHardwareDialog?: (
    ...
    showProgramTooLargeErrorAsync?: (
      variants: string[],
      confirmAsync: (options: any) => Promise<number>
    ) => Promise<pxt.commands.RecompileOptions>;
    toolboxOptions?: IToolboxOptions;
    blocklyPatch?: (pkgTargetVersion: string, dom: Element) => void;
    webUsbPairDialogAsync?: (
      pairAsync: () => Promise<boolean>,
      confirmAsync: (options: any) => Promise<number>
    ) => Promise<number>;
    mkPacketIOWrapper?: (
  ...
  type AssetEditorRequest =
    | OpenAssetEditorRequest
    | CreateAssetEditorRequest
    | SaveAssetEditorRequest
    | DuplicateAssetEditorRequest;
  ...
  type AssetEditorResponse =
    | OpenAssetEditorResponse
    | CreateAssetEditorResponse
    | SaveAssetEditorResponse
    | DuplicateAssetEditorResponse;
...
declare namespace pxt.workspace {
  export interface WorkspaceProvider {
    ...
    setAsync(
      ...
      prevVersion: pxt.workspace.Version,
      text?: pxt.workspace.ScriptText
    ): Promise<pxt.workspace.Version>;
    deleteAsync?: (
      h: pxt.workspace.Header,
      prevVersion: pxt.workspace.Version
    ) => Promise<void>;
