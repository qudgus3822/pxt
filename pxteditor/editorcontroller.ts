...
const pendingRequests: pxt.Map<{
  resolve: (
    res?:
      | pxt.editor.EditorMessageResponse
      | PromiseLike<pxt.editor.EditorMessageResponse>
  ) => void;
  reject: (err: any) => void;
}> = {};
...
export function bindEditorMessages(
  getEditorAsync: () => Promise<IProjectView>
) {
  const allowEditorMessages =
    ...
    if (data.type === "pxtpkgext" && allowExtensionMessages) {
      ...
      if (data.type == "pxthost") {
        ...
        if (!req) {
          ...
          p = p.then(() =>
            req.resolve(data as pxt.editor.EditorMessageResponse)
          );
        }
        ...
        p = p.then(() => {
          return getEditorAsync().then((projectView) => {
            ...
            switch (
              req.action.toLowerCase() as pxt.editor.EditorMessageRequest["action"]
            ) {
              ...
              case "switchpython":
                return Promise.resolve().then(() => projectView.openPython());
              case "switchblocks":
                return Promise.resolve().then(() => projectView.openBlocks());
              case "startsimulator":
                return Promise.resolve().then(() =>
              ...
              case "closeflyout":
                return Promise.resolve().then(() => projectView.closeFlyout());
              case "unloadproject":
                return Promise.resolve().then(() =>
                  projectView.unloadProjectAsync()
                );
              case "saveproject":
                return projectView.saveProjectAsync();
              case "compile":
                return projectView.compile();
              case "compileonlypostmessage":
                return projectView.compileOnlyPostMessage(true);
              case "redo":
                return Promise.resolve().then(() => {
                  const editor = projectView.editor;
                  if (editor && editor.hasRedo()) editor.redo();
                });
              case "undo":
                return Promise.resolve().then(() => {
                  const editor = projectView.editor;
                  if (editor && editor.hasUndo()) editor.undo();
                });
              case "setscale": {
              ...
              case "newproject": {
                const create =
                  data as pxt.editor.EditorMessageNewProjectRequest;
                return Promise.resolve().then(() =>
              ...
              case "importproject": {
                const load =
                  data as pxt.editor.EditorMessageImportProjectRequest;
                return Promise.resolve().then(() =>
                  projectView.importProjectAsync(load.project, {
              ...
              case "importexternalproject": {
                const importExternal =
                  data as pxt.editor.EditorMessageImportExternalProjectRequest;
                return saveProjectAsync(importExternal.project).then(
                  (importId) => {
                    const importUrl =
                      location.origin +
                      location.pathname +
                      `#embedimport:${importId}`;
                    resp = {
                      importUrl,
              ...
              case "startactivity": {
                ...
                if (/^([jt]s|py|blocks?):/i.test(tutorialPath)) {
                  ...
                  tutorialPath = tutorialPath.substr(
                    tutorialPath.indexOf(":") + 1
                  );
                }
                return Promise.resolve().then(() =>
              ...
              case "importtutorial": {
                const load =
                  data as pxt.editor.EditorMessageImportTutorialRequest;
                return Promise.resolve().then(() =>
                  projectView.importTutorialAsync(load.markdown)
                );
              }
              case "proxytosim": {
                const simmsg =
                  data as pxt.editor.EditorMessageSimulatorMessageProxyRequest;
                return Promise.resolve().then(() =>
              ...
              case "renderblocks": {
                const rendermsg =
                  data as pxt.editor.EditorMessageRenderBlocksRequest;
              ...
              case "renderxml": {
                const rendermsg =
                  data as pxt.editor.EditorMessageRenderXmlRequest;
                return Promise.resolve().then(() => {
              ...
              case "renderbyblockid": {
                const rendermsg =
                  data as pxt.editor.EditorMessageRenderByBlockIdRequest;
                return Promise.resolve()
              ...
              case "gettoolboxcategories": {
                const msg =
                  data as pxt.editor.EditorMessageGetToolboxCategoriesRequest;
                return Promise.resolve().then(() => {
              ...
              case "getblockastext": {
                const msg =
                  data as pxt.editor.EditorMessageGetBlockAsTextRequest;
                return Promise.resolve().then(() => {
                  const readableName = projectView.getBlockAsText(msg.blockId);
                  resp = {
                    blockAsText: readableName,
                  } as pxt.editor.EditorMessageGetBlockAsTextResponse;
                });
              }
              case "renderpython": {
                const rendermsg =
                  data as pxt.editor.EditorMessageRenderPythonRequest;
                return Promise.resolve()
              ...
              case "toggletrace": {
                const togglemsg =
                  data as pxt.editor.EditorMessageToggleTraceRequest;
                return Promise.resolve().then(() =>
              ...
              case "settracestate": {
                const trcmsg =
                  data as pxt.editor.EditorMessageSetTraceStateRequest;
                return Promise.resolve().then(() =>
              ...
              case "setsimulatorfullscreen": {
                const fsmsg =
                  data as pxt.editor.EditorMessageSetSimulatorFullScreenRequest;
                return Promise.resolve().then(() =>
              ...
              case "sethighcontrast": {
                const hcmsg =
                  data as pxt.editor.EditorMessageSetHighContrastRequest;
                return Promise.resolve().then(() =>
              ...
              case "print": {
                return Promise.resolve().then(() => projectView.printCode());
              }
              case "pair": {
              ...
              case "shareproject": {
                ...
                return projectView
                  .anonymousPublishHeaderByIdAsync(
                    msg.headerId,
                    msg.projectName
                  )
                  .then((scriptInfo) => {
              ...
              case "savelocalprojectstocloud": {
                const msg =
                  data as pxt.editor.EditorMessageSaveLocalProjectsToCloud;
                return projectView
                  .saveLocalProjectsToCloudAsync(msg.headerIds)
                  .then((guidMap) => {
                    resp = <
                      pxt.editor.EditorMessageSaveLocalProjectsToCloudResponse
                    >{
                      headerIdMap: guidMap,
                    };
                  });
              ...
              case "requestprojectcloudstatus": {
                ...
                const msg =
                  data as pxt.editor.EditorMessageRequestProjectCloudStatus;
                return projectView.requestProjectCloudStatus(msg.headerIds);
              }
              case "convertcloudprojectstolocal": {
                const msg =
                  data as pxt.editor.EditorMessageConvertCloudProjectsToLocal;
              ...
              case "setlanguagerestriction": {
                ...
                if (msg.restriction === "no-blocks") {
                  ...
                  throw new Error(
                    "no-blocks language restriction is not supported"
                  );
                }
              ...
              case "precachetutorial": {
                ...
                return pxt.github.db
                  .cacheReposAsync(tutorialData)
                  .then(async () => {
...
function sendResponse(
  request: pxt.editor.EditorMessage,
  resp: any,
  success: boolean,
  error: any
) {
...
export function shouldPostHostMessages() {
  return (
    pxt.appTarget.appTheme.allowParentController && pxt.BrowserUtils.isIFrame()
  );
}
 ...
 */
export function postHostMessageAsync(
  msg: pxt.editor.EditorMessageRequest
): Promise<pxt.editor.EditorMessageResponse> {
  return new Promise<pxt.editor.EditorMessageResponse>((resolve, reject) => {
    ...
    if (msg.response) pendingRequests[env.id] = { resolve, reject };
    ...
    if (!msg.response) resolve(undefined);
  });
}
